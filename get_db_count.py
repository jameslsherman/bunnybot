...
def list_docs():
    ...
    # docs = db.collection('images').where(u'hash', u'>', '').stream()  # 1084
    # docs = db.collection('images').where(u'rabbit_cuteness', u'>', 0).stream()  # 1068
    # docs = db.collection('images').where(u'rabbit_cuteness', u'==', 0).stream()  # 18
    docs = db.collection('images').where(u'username', u'>', '').stream()  # 1084
